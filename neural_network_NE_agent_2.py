...
class NNM_1_Cascading_random:
    def __init__(self, input_layer, neurons_in_layer_n, output_layer):
        ...
        self.neuron_number = [neurons_in_layer_n, neurons_in_layer_n, neurons_in_layer_n, neurons_in_layer_n, neurons_in_layer_n, output_layer]  # To keep in track of the number of neurons in network to calculate consecutive neurons in the layers
...
class NNM_1_Cascading:
    def __init__(self, input_layer, neurons_in_layer_n, output_layer, weights, biases):
        ...
        self.neuron_number = [
            neurons_in_layer_n, neurons_in_layer_n, neurons_in_layer_n,neurons_in_layer_n, neurons_in_layer_n, output_layer]  # To keep in track of the number of neurons in network to calculate consecutive neurons in the layers
...
class Evolution:
    def __init__(self):
        ...
        self.generation = first_generation(genomes, 24, 64, 4)
